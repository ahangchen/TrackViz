...
def get_predict_delta_tracks(fusion_param, useful_predict_limit=10, random=False, diff_person=False, use_real_st=False):
    ...
    if '_dukequerytail' in fusion_param['renew_pid_path']:
        ...
        return get_predict_frame_delta_tracks(fusion_param, useful_predict_limit=useful_predict_limit, random=random,
                                              diff_person=diff_person, use_real_st=use_real_st)
    else:
        return get_predict_pure_delta_tracks(fusion_param, useful_predict_limit=useful_predict_limit, random=random, diff_person=diff_person, use_real_st=use_real_st)


def get_predict_pure_delta_tracks(fusion_param, useful_predict_limit=10, random=False, diff_person=False, use_real_st=False):
    # 获取左图列表
