...
do
    ...
    do
        ...
        transfer_feature="${VISION_DIR}/${source_names[$j]}_${target_names[$i]}-train/train_ft.mat"
        $PYTHON2 st_cluster.py --train_list $train_list --transfer_feature $transfer_feature --transfer ${source_names[$j]}_${target_names[$i]}
    done
done